...
htmlRouter.get("/notes", (req, res) => {
  // this is a GET request for the /notes route
...
htmlRouter.get("*", (req, res) => {
  // this is a GET request for * (wildcard); if no other routes are specified with the api url, then the index.html is returned to the client
